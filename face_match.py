...
detector_path = "data/detector_buddhism.svm"
# 人脸关键点检测器
...
def face_similar(imgpath):
    try:
        ##    test_path=input('请输入要检测的图片的路径（记得加后缀哦）:')
        # imgname = "faces/image.jpg"
        imgname = imgpath
        img = io.imread(r"examples/johns/John_Salley/000179_02159509.jpg")
...
if __name__ == '__main__':
    face_similar("examples/johns/John_Salley/000179_02159509.jpg")
